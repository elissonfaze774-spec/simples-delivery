      ...
      <div className="mx-auto max-w-screen-lg px-4 py-6">
        {items.length === 0 ? (
          <div className="py-12 text-center">
            ...
            <Button onClick={() => navigate(backUrl)} className="bg-[#EA1D2C] hover:bg-[#D01929]">
              Ver Cardápio
            </Button>
          </div>
        ) : (
                  ...
                  <div key={itemId} className="rounded-lg bg-white p-4 shadow-sm">
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="mt-1 font-semibold text-[#EA1D2C]">{formatMoney(itemPrice)}</p>
                        ...
                        <div className="mt-2 flex items-center gap-3">
                          ...
                          <Button variant="ghost" size="sm" onClick={() => removeFromCart(itemId)}>
