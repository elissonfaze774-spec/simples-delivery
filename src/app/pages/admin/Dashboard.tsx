...
function SimpleBarChart({ data }: { data: DailyChartItem[] }) {
  ...
  return (
    <div className="rounded-[28px] border border-red-950/40 bg-[#101010] p-5 shadow-[0_10px_30px_rgba(0,0,0,0.35)]">
          ...
          return (
            <div key={item.label} className="flex flex-1 flex-col items-center gap-3">
              ...
              <div className="text-center">
                ...
                <div className="text-[11px] text-zinc-400">{item.orders} pedidos</div>
              </div>
            </div>
          );
        })}
...
function QuickStatCard({
  ...
  return (
    <Card className="rounded-[28px] border border-red-950/40 bg-[#101010] p-5 shadow-[0_10px_30px_rgba(0,0,0,0.35)]">
...
export function AdminDashboard() {
  ...
  const whatsapp = String(
    (resolvedStore as { whatsapp?: string }).whatsapp || 'Pendente'
  );
    ...
    return (
      <div className="min-h-screen bg-[#070707] px-6 py-10 text-white">
        <div className="mx-auto flex min-h-[80vh] max-w-2xl items-center justify-center">
          <div className="w-full rounded-[32px] border border-red-950/40 bg-[#101010] p-8 text-center shadow-[0_20px_60px_rgba(0,0,0,0.45)]">
            ...
            <h1 className="mt-6 text-3xl font-black text-white">Loja suspensa</h1>

            <p className="mt-3 text-sm leading-6 text-zinc-400">
              O acesso ao painel foi bloqueado porque sua loja está suspensa no momento.
              Regularize sua assinatura ou entre em contato com o suporte para voltar a usar
              o painel administrativo.
            </p>

            <div className="mt-6 rounded-3xl border border-red-500/20 bg-red-500/10 p-4 text-sm text-red-200">
              Enquanto a loja estiver suspensa, produtos, pedidos, cupons e configurações
              ficam indisponíveis neste painel.
            </div>
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <Button
                ...
                className="rounded-full border-0 bg-[#f3162d] px-6 text-white shadow-[0_8px_24px_rgba(243,22,45,0.35)] transition hover:bg-[#d90f24]"
              >
                Voltar ao login
              </Button>
              ...
              <Button
                ...
                className="rounded-full border-zinc-700 bg-black px-6 text-white hover:border-red-500/40 hover:bg-zinc-900"
              >
                Tentar novamente
              </Button>
            </div>
  ...
  const absoluteStoreUrl = `${window.location.origin}/loja/${encodeURIComponent(storeSlug)}`;
      ...
      <AdminShell
        ...
        actions={
          <Button
            ...
            className="rounded-full border-0 bg-[#f3162d] px-5 text-white shadow-[0_8px_24px_rgba(243,22,45,0.35)] transition hover:bg-[#d90f24]"
          >
      ...
      >
        <div className="space-y-6 text-white">
          <section className="grid gap-4 xl:grid-cols-[1.35fr_0.65fr]">
            <Card className="overflow-hidden rounded-[32px] border border-red-950/40 bg-gradient-to-br from-[#160507] via-[#0b0b0b] to-[#111111] p-0 shadow-[0_20px_60px_rgba(0,0,0,0.45)]">
              <div className="p-7">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div className="inline-flex items-center gap-2 rounded-full border border-red-500/20 bg-red-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-red-300">
                ...
                <h2 className="mt-5 max-w-2xl text-3xl font-black leading-tight text-white">
            ...
            <Card className="rounded-[32px] border border-red-950/40 bg-[#101010] p-6 shadow-[0_10px_30px_rgba(0,0,0,0.35)]">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-zinc-400">Sua loja online</p>
                  <h3 className="mt-1 text-2xl font-black text-white">Link da vitrine</h3>
                </div>
              ...
              <div className="mt-5 grid gap-3">
                <Button
                  type="button"
                  className="rounded-full border-0 bg-[#f3162d] text-white shadow-[0_8px_24px_rgba(243,22,45,0.35)] transition hover:bg-[#d90f24]"
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="rounded-full border-zinc-700 bg-black text-white hover:border-red-500/40 hover:bg-zinc-900"
                  onClick={() => navigate('/admin/settings')}
                >
            ...
            <Card className="rounded-[28px] border border-red-950/40 bg-[#101010] p-5 shadow-[0_10px_30px_rgba(0,0,0,0.35)]">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h3 className="mt-2 text-xl font-bold text-white">Sua loja este mês</h3>
                </div>
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="rounded-3xl border border-zinc-800 bg-[#0b0b0b] p-4">
                  ...
                  <p className="mt-2 text-lg font-bold text-white">{whatsapp}</p>
                </div>
              </div>
            </Card>
          </section>
          ...
          <section className="grid gap-4 xl:grid-cols-[0.95fr_1.05fr]">
                ...
                {shortcuts.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex items-center gap-4 rounded-3xl border border-zinc-800 bg-[#0b0b0b] p-4 text-left transition hover:border-red-500/30 hover:bg-[#151515]"
                    >
                      <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-red-500/20 bg-red-500/10 text-red-300">
                        <Icon className="h-5 w-5" />
                      </div>
            ...
            <Card className="rounded-[28px] border border-red-950/40 bg-[#101010] p-5 shadow-[0_10px_30px_rgba(0,0,0,0.35)]">
              ...
              {latestOrders.length === 0 ? (
                <div className="rounded-3xl border border-zinc-800 bg-[#0b0b0b] p-10 text-center text-sm text-zinc-400">
